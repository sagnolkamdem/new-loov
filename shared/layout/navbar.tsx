...
const Navbar = () => {
    return ( 
        <header className="flex flex-row bg-white px-8 py-2.5 shadow justify-between">
            ...
            <div className="flex gap-10">
                ...
                <SearchInput placeholder="Search" name="search" class="w-72"/>

            </div>

            <div className="flex items-center divide-x divide-gray-200">
                <button className="flex items-center gap-4 px-4 text-slate-600 text-sm font-normal">
