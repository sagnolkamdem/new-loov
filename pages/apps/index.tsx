...
const Apps = () => {
    return ( 
        <Layout>
            ...
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 lg:gap-x-6 gap-6 overflow-hidden">

                <div className="bg-white divide-y divide-gray-100 w-full p-5 rounded-lg transition duration-300 hover:shadow-lg">
