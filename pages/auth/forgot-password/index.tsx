        ...
        <AuthLayout>
            <section className="col-span-5 grid place-items-center py-8 max-sm:py-0 z-20">
                ...
                <div className="mx-auto">
                    ...
                    <h1 className="font-semibold text-2xl leading-9 text-slate-900 mb-2">Mot de passe oublié</h1>
                    ...
                    <div className="max-w-sm">
                        ...
                        <form className="flex flex-col w-full items-end mt-9 mb-6">
                            ...
                            <SimpleInput class="mb-6" blockClass="w-full" type="email" label="email" name="email" placeholder="janeDoe@gmail.com" />

                            <SimpleButton class="mb-2 max-w-fit" text="Envoyer le lien de reinitialisation"></SimpleButton>
